        ...
        <section className="w-full py-24 bg-slate-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1450px]">
                <div className="text-center mb-20">
                    <h2 className="text-[36px] md:text-[48px] font-[850] text-[#121121] tracking-tight">
                        Select Your Plan
                    </h2>
                    ...
                    {plans.map((plan, idx) => (
                        <div
                            ...
                            className={cn(
                                ...
                                plan.recommended
                                    ? "border-[#D60D26] shadow-2xl shadow-red-100 scale-105 z-20 py-14"
                                    : "border-gray-100 shadow-sm hover:shadow-xl z-10"
                            )}
                        >
                            {/* FREE FLIGHT ribbon */}
                            {plan.recommended && (
                                <div className="absolute -top-4 -right-4 bg-[#D60D26] text-white px-6 py-2 rounded-2xl rotate-12 font-[800] text-[14px] shadow-lg flex items-center gap-1.5 animate-pulse">
                            ...
                            <div className="mb-10">
                                <span className={cn(
                                    ...
                                    plan.recommended ? "bg-rose-50 text-[#D60D26]" : "bg-gray-50 text-gray-500"
                                )}>
                                    {plan.name}
                                </span>
                                ...
                                {plan.features.map((feature) => (
                                    <div key={feature} className="flex items-center gap-3">
                                        <div className={cn(
                                            ...
                                            plan.recommended ? "bg-[#D60D26]/10 text-[#D60D26]" : "bg-gray-100 text-gray-400"
                                        )}>
                            ...
                            <button className={cn(
                                ...
                                plan.recommended
                                    ? "bg-[#D60D26] text-white shadow-xl shadow-red-200 hover:bg-[#D60D26]"
                                    : "bg-white border-2 border-gray-100 text-gray-800 hover:border-red-100 hover:text-[#D60D26]"
                            )}>
                                Get Started
