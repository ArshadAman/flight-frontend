  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-xl w-full max-w-[500px] overflow-hidden shadow-2xl flex flex-col animate-in zoom-in-95 duration-200">
        ...
        {/* Header */}
        <div className="bg-[#FBEBEF] px-6 py-4 flex items-center justify-between border-b border-slate-100">
          <h2 className="text-[#DF1B24] text-[18px] font-bold tracking-tight">Rules</h2>
        ...
        {/* Penalties Box */}
        <div className="bg-[#EBEBEB] px-6 py-5">
