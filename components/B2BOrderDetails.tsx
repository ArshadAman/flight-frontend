  ...
  return (
    <div className="w-full flex flex-col min-h-screen bg-[#ffffff]">
      ...
      <div className="flex w-full min-h-[50px] select-none text-[12px] font-bold">
        <div className="flex-[3] bg-[#DE0A26] text-white flex flex-wrap items-center gap-6 px-10 py-2">
      ...
      <div className="w-full max-w-[1280px] mx-auto py-8 px-4 flex flex-col">
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm mb-6 flex flex-col">
              <div className="bg-[#102A4A] px-6 py-3 flex items-center justify-between">
              ...
              <div className="bg-[#F8F9FA] px-6 py-5 grid grid-cols-1 md:grid-cols-3 gap-6">
                  {/* Col 1 */}
                  ...
                  <div className="flex flex-col items-end gap-5">
                      <div className="flex items-center gap-2">
                          ...
                          <Button variant="outline" className="h-[28px] px-3 text-[11px] font-bold border-slate-300 text-[#DE0A26] flex items-center gap-1.5 hover:text-[#C1161E] hover:bg-red-50">
                      ...
                      <div className="text-[#DE0A26] font-black text-[32px] tracking-tight leading-none mt-1">
                          $123.89
                      </div>
                  </div>
              </div>
          ...
          {/* Passenger Details */}
          <div className="bg-[#F0F7FA]/30 rounded-xl border border-[#e1eaf0] flex flex-col mb-6">
              <div className="px-6 py-4 border-b border-[#e1eaf0] bg-[#F0F7FA]/60 rounded-t-xl">
              ...
              <div className="p-6 pb-2">
                  <label className="flex items-center gap-2.5 cursor-pointer group w-fit mb-6">
                      <div className="w-4 h-4 rounded-full border-2 border-[#DE0A26] flex items-center justify-center">
                          <div className="w-2 h-2 bg-[#DE0A26] rounded-full" />
                      </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 flex flex-col mb-6 shadow-sm overflow-hidden">
              <div className="bg-[#F0F7FA]/50 px-6 py-4 border-b border-slate-100">
          ...
          <div className="bg-[#102A4A] px-6 py-3.5 rounded-xl shadow-sm mb-6 flex items-center">
              <h2 className="text-white font-bold text-[15px]">Additional services</h2>
          </div>

          {/* Payment details block */}
          <div className="bg-white rounded-xl border border-slate-200 flex flex-col mb-6 shadow-sm overflow-hidden">
              <div className="bg-[#1D70B8] px-6 py-3.5">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-2 mb-16">
              <Button className="bg-[#DE0A26] hover:bg-[#C1161E] text-white rounded-[100px] h-[46px] px-10 font-bold text-[14px] shadow-sm flex items-center gap-2 transition-transform active:scale-95">
