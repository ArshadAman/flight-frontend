    ...
    <div className="min-h-screen bg-gray-100 flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-[900px] mx-auto px-4 py-6 pb-16">
        ...
        <div className="flex items-center gap-2 text-base text-gray-500 mb-5">
          ...
          <span>›</span>
          <Link href="/b2b/group-travel/make-payment" className="hover:underline">Make payment</Link>
          <span>›</span>
          ...
          <div className="flex gap-4 pt-2">
            ...
            <button 
              onClick={() => {
                ...
                router.push(`/b2b/group-travel/make-payment/payment-portal?id=${displayData.requestId}`);
              }}
