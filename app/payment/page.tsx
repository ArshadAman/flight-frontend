...
export default function PaymentPage() {
    ...
    return (
        <main className="min-h-screen bg-white flex flex-col font-sans relative">
            <Navbar />
            {/* Gradient Header */}
            <div className="w-full bg-gradient-to-r from-[#DF1B24] via-[#6e0f1d] to-[#121021] pt-6 pb-16 px-4 md:px-10 lg:px-20 relative z-0 flex flex-col sm:flex-row justify-between items-start sm:items-end">
                <div>
                    {/* Breadcrumb */}
                ...
                {activeTab === "payment-request" && (
                    <button 
                        ...
                        className="mt-4 sm:mt-0 bg-[#DF1B24] hover:bg-[#C1161E] text-white px-6 py-2.5 rounded-full font-bold text-[14px] transition-colors shadow-sm"
                    >
                                ...
                                <div className="bg-white p-6 md:p-8 rounded-b-xl rounded-tr-xl shadow-sm border border-slate-100 flex flex-col gap-8">
                                    ...
                                    {selectedMethod === "Card" && (
                                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 w-full animate-in fade-in zoom-in-95 duration-200">
                                            <input type="text" placeholder="Card Number" className="sm:col-span-2 border border-slate-200 rounded-lg px-4 py-2.5 outline-none focus:border-[#DF1B24] text-[14px] font-medium text-slate-800 placeholder:text-slate-400" />
                                            <input type="text" placeholder="Month" className="border border-slate-200 rounded-lg px-4 py-2.5 outline-none focus:border-[#DF1B24] text-[14px] font-medium text-slate-800 placeholder:text-slate-400" />
                                            <input type="text" placeholder="Year" className="border border-slate-200 rounded-lg px-4 py-2.5 outline-none focus:border-[#DF1B24] text-[14px] font-medium text-slate-800 placeholder:text-slate-400" />
                                            <input type="text" placeholder="CVV" className="border border-slate-200 rounded-lg px-4 py-2.5 outline-none focus:border-[#DF1B24] text-[14px] font-medium text-slate-800 placeholder:text-slate-400" />
                                            <input type="text" placeholder="Full Name As On Card" className="sm:col-span-3 border border-slate-200 rounded-lg px-4 py-2.5 outline-none focus:border-[#DF1B24] text-[14px] font-medium text-slate-800 placeholder:text-slate-400" />
                                        </div>
                                    )}

                                    {selectedMethod === "Net Banking" && (
                                        <div className="flex flex-col gap-4 w-full max-w-[400px] animate-in fade-in zoom-in-95 duration-200">
                                            <select className="border border-slate-200 rounded-lg px-4 py-3 outline-none focus:border-[#DF1B24] text-[14px] font-medium text-slate-800 bg-white">
                                    ...
                                    {selectedMethod === "Wallet" && (
                                        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-[500px] animate-in fade-in zoom-in-95 duration-200">
                                            <select className="flex-1 border border-slate-200 rounded-lg px-4 py-3 outline-none focus:border-[#DF1B24] text-[14px] font-medium text-slate-800 bg-white">
                                                <option value="">Select Wallet</option>
                                                <option value="paytm">Paytm</option>
                                                <option value="phonepe">PhonePe</option>
                                                <option value="gpay">Google Pay</option>
                                            </select>
                                            <input type="text" placeholder="Mobile / UPI ID" className="flex-1 border border-slate-200 rounded-lg px-4 py-3 outline-none focus:border-[#DF1B24] text-[14px] font-medium text-slate-800 placeholder:text-slate-400" />
                                        </div>
                                    )}
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-2 bg-white -mx-6 -my-10 rounded-t-[2.5rem] rounded-b-[1.5rem] p-6 md:p-12 shadow-sm min-h-[500px]">
                            ...
                            <div className="flex flex-wrap items-end gap-6 border-b border-slate-100 pb-6 mb-6">
                                <div className="flex flex-col gap-1 w-full sm:w-[140px]">
                                    ...
                                    <select className="w-full border-b border-slate-300 pb-1 text-slate-800 text-[13px] font-semibold bg-transparent outline-none focus:border-[#DF1B24] cursor-pointer">
                                ...
                                <div className="flex flex-col gap-1 w-full sm:w-[130px]">
                                    ...
                                    <input type="date" className="w-full border-b border-slate-300 pb-1 text-slate-800 text-[13px] font-semibold bg-transparent outline-none focus:border-[#DF1B24] cursor-pointer" />
                                </div>
                                <div className="flex flex-col gap-1 w-full sm:w-[130px]">
                                ...
                                <div className="flex items-center gap-4 w-full sm:w-auto mt-2 sm:mt-0 sm:ml-auto">
                                    <button className="bg-[#780d19] hover:bg-[#5f0a14] text-white px-6 py-2 rounded-full font-bold text-[13px] transition-colors shadow-sm flex-1 sm:flex-none">
                                        Apply Filters
                                    </button>
                                    <button type="reset" className="text-[#DF1B24] font-bold text-[13px] hover:underline px-2">
                                        Reset
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-2 bg-white -mx-6 -my-10 rounded-t-[2.5rem] rounded-b-[1.5rem] p-6 md:p-12 shadow-sm min-h-[500px]">
                            ...
                            <div className="mb-10 w-full max-w-[300px]">
                                <input
                                    ...
                                    className="w-full bg-transparent border-b border-slate-300 py-2 outline-none text-[16px] text-slate-800 font-semibold placeholder:text-slate-500 focus:border-[#DF1B24] transition-colors"
                                />
                            </div>
                            ...
                            <div className="flex justify-center mt-12">
                                <button className="w-full max-w-[400px] h-[54px] rounded-full bg-[#DF1B24] text-white font-bold text-[16px] flex items-center justify-center gap-2 hover:bg-[#C1161E] transition-colors shadow-md active:scale-[0.98]">
            ...
            {isRequestModalOpen && (
                <div className="fixed inset-0 bg-black/60 z-[9999] flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl w-full max-w-[500px] shadow-2xl overflow-hidden animate-in zoom-in-95">
                        <div className="bg-[#DF1B24] px-6 py-4 flex items-center justify-between text-white">
                        ...
                        <div className="p-6">
                            <div className="bg-red-50 text-[#DF1B24] p-3 text-[12px] font-semibold rounded-lg mb-6 leading-relaxed">
                            ...
                            <div className="space-y-4 max-h-[50vh] overflow-y-auto pr-2">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                                    ...
                                    <select className="flex-1 outline-none text-[14px] text-slate-800 bg-transparent border border-slate-200 rounded px-3 py-2 focus:border-[#DF1B24]">
                                        <option value="all">All</option>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                                    ...
                                    <input type="number" placeholder="Enter amount" className="flex-1 outline-none text-[14px] text-slate-800 placeholder:text-slate-300 border border-slate-200 rounded px-3 py-2 focus:border-[#DF1B24]" />
                                </div>
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                                    ...
                                    <input type="text" placeholder="Enter transaction number" className="flex-1 outline-none text-[14px] text-slate-800 placeholder:text-slate-300 border border-slate-200 rounded px-3 py-2 focus:border-[#DF1B24]" />
                                </div>
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                                    ...
                                    <input type="text" placeholder="Enter branch name" className="flex-1 outline-none text-[14px] text-slate-800 placeholder:text-slate-300 border border-slate-200 rounded px-3 py-2 focus:border-[#DF1B24]" />
                                </div>
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                                    <span className="text-slate-500 text-[13px] font-semibold w-[140px]">Issued date</span>
                                    <input type="date" className="flex-1 outline-none text-[14px] text-slate-800 bg-transparent border border-slate-200 rounded px-3 py-2 focus:border-[#DF1B24]" />
                                </div>
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                            ...
                            <div className="flex items-center gap-4 mt-8">
                                ...
                                <button className="flex-1 h-[44px] rounded-full bg-[#DF1B24] text-white font-bold text-[14px] hover:bg-[#C1161E] transition-colors">
                                    Submit
                                </button>
                            </div>
                        </div>
