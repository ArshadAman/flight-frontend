    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto bg-white shadow-sm mt-4 mb-10 overflow-hidden relative pb-20">
            ...
            {tabs.map((tab) => (
              ...
              >
                {tab === 'Make Payment' ? (
                  ...
                  <Link href="/group-travel/view-request">{tab}</Link>
                ) : tab === 'Add Passenger' ? (
        ...
        <div className="px-8 mt-10">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-900">Showing {paidPayments.length}</h2>
               ...
               paidPayments.map((req, index) => (
                 ...
                 >
                   ...
                   <div className="flex items-center gap-5">
                     ...
                     <div className="flex flex-col items-start min-w-[70px]">
                       <div className="flex items-center gap-1 font-bold text-gray-900 text-[15px]">
                         {req.destination} <span className="text-[#E11D48] text-xs" style={{display:'inline-block',transform:'scaleX(-1)'}}>✈</span> {req.origin}
                       </div>
                   ...
                   {/* Airline */}
                   <div className="pr-2">
                     <span className="text-[#E11D48] font-bold text-[15px] tracking-wide uppercase leading-tight truncate">
                   ...
                   <div className="flex flex-col text-[14px] pr-2">
                     ...
                     <span className="text-[#E11D48] truncate">Request Date: {req.requestDate}</span>
                   </div>
                   ...
                   <div className="flex items-center justify-between pl-1">
                     <div className="flex flex-col items-start gap-0.5">
                       <span className="font-bold text-[15px] text-green-600">Payment Complete</span>
                       {req.validTill && (
                     ...
                     <button
                       className="text-gray-400 cursor-not-allowed text-[15px] font-medium border-l border-gray-200 pl-3 ml-2 whitespace-nowrap"
                     >
                       View Details
                     </button>
                   </div>
