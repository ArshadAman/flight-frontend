...
function PaymentPortalContent() {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(async () => {
      ...
      setTimeout(() => {
        router.push(`/group-travel/make-payment/payment-summary?id=${requestId || 'GRP1134718273'}`);
      }, 1200);
    }, 2000);
  };
    ...
    <div className="min-h-screen bg-[#F2FBFF] flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-[1000px] mx-auto px-4 py-8 pb-20">
        ...
        <div className="flex items-center gap-2 text-[14px] text-gray-500 mb-6">
          <Link href="/group-travel/view-request" className="hover:text-[#D60D26] transition-colors">Request</Link>
          <ChevronRight className="w-4 h-4" />
          <Link href="/group-travel/make-payment" className="hover:text-[#D60D26] transition-colors">Make payment</Link>
          <ChevronRight className="w-4 h-4" />
          <Link href="/group-travel/make-payment/payment-summary" className="hover:text-[#D60D26] transition-colors">Payment summary</Link>
          <ChevronRight className="w-4 h-4" />
