    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-[1000px] mx-auto px-4 py-8 pb-20">
        ...
        <div className="flex items-center gap-2 text-[14px] text-gray-500 mb-6">
          <Link href="/group-travel/view-request" className="hover:text-[#E11D48] transition-colors">Request</Link>
          <ChevronRight className="w-4 h-4" />
          <Link href="/group-travel/make-payment" className="hover:text-[#E11D48] transition-colors">Make payment</Link>
          <ChevronRight className="w-4 h-4" />
          <Link href="/group-travel/make-payment/payment-summary" className="hover:text-[#E11D48] transition-colors">Payment summary</Link>
          <ChevronRight className="w-4 h-4" />
