...
const ADD_PASSENGER_DATA = [
  {
    ...
    airline: "AIR INDIA",
    requestDate: "01Aug,25(03:23)",
    validTill: "08 Feb,26(03:00)",
    pnrDelBkk: "XBYZ102",
    pnrBkkDel: "ABYZ902",
    passengers: "12 pax(12A)",
    flightFrom: "DEL",
    flightTo: "BKK",
    returnFrom: "BKK",
    returnTo: "DEL",
    departDate: "19 Aug, 25",
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
            ...
            <div className="border-b border-gray-300 pb-1 relative">
              <select className="w-full bg-transparent border-none outline-none text-[17px] text-gray-500 appearance-none cursor-pointer pr-6">
                ...
                <option value="pnr-submitted">PNR Submitted</option>
              </select>
            ...
            {ADD_PASSENGER_DATA.map((req, index) => (
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-gray-900 font-bold text-[16px]">{req.groupName}</span>
                  <span className="text-gray-500 text-[14px]">{req.requestId}</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex flex-col items-start gap-0.5">
                    <span className="font-bold text-[15px] text-green-500">{req.status}</span>
                    <span className="text-[13px] text-gray-500 whitespace-nowrap">
                      Valid till: {req.validTill}
                    </span>
                  </div>
                  <Link
                    href={`/group-travel/add-passenger/add-pax-details?id=${req.requestId}`}
                    className="text-blue-600 hover:underline text-[15px] font-medium border-l border-gray-200 pl-4 ml-4 whitespace-nowrap"
                  >
                    Pax Details
                  </Link>
                </div>
