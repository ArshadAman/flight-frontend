...
export default function MyAccountPage() {
    return (
        <div className="w-full min-h-screen bg-slate-50 flex flex-col">
            ...
            {/* Main Content Area */}
            <main className="container mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-16 flex-1">
                <div className="bg-white p-6 sm:p-10 rounded-2xl shadow-sm border border-slate-200">
                    <h2 className="text-2xl font-bold text-slate-800 mb-4 sm:mb-6">Dashboard Overview</h2>
